...
import {covidMapboxAPIBaseURL} from "../../constants/Api";
...
function App() {
  ...
  const {data} = useSWR(covidMapboxAPIBaseURL, fetcher);
        ...
        map.on('mousemove', 'circles', (e) => {
          ...
          if (id !== lastId) {
            ...
            const countryFlagHTML = Boolean(countryISO)
                ? `<img src="https://www.countryflags.io/${countryISO}/flat/64.png" alt="flag"/>`
                : '';
